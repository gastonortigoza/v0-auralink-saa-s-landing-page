        ...
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              ...
              >
                en una sola plataforma conectada con todos tus proveedores.
              </span>
            </h2>
            ...
            >
              Toda la información y proveedores del evento, centralizados. Personas o inteligencia artificial gestionando eventos por vos.
            </p>
